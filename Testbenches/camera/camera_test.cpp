...
int main ( int argc,char **argv ) {
	...
	cv::Mat green, blue, red, yellow, white;
	...
	while(1) {
		...
		cv::findContours(red, green_contours, hierarchy, cv::RETR_EXTERNAL, cv::CHAIN_APPROX_SIMPLE);
		//cv::findContours(blue, blue_contours, hierarchy, cv::CV_RETR_EXTERNAL, CV_CHAIN_APPROX_SIMPLE);
		//cv::findContours(red, red_contours, hierarchy, cv::CV_RETR_EXTERNAL, CV_CHAIN_APPROX_SIMPLE);
		//cv::findContours(yellow, yellow_contours, hierarchy, cv::CV_RETR_EXTERNAL, CV_CHAIN_APPROX_SIMPLE);
		//cv::findContours(white, white_contours, hierarchy, cv::CV_RETR_EXTERNAL, CV_CHAIN_APPROX_SIMPLE);
