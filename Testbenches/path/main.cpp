...
int main(int argc, char **argv) {
    ...
    string commands[] = {
        ...
        to_string(3) + ' ' + to_string(90.0),
        to_string(1) + ' ' + to_string(10.0),
        to_string(2) + ' ' + to_string(90.0),
        to_string(1) + ' ' + to_string(13.0),
        to_string(3) + ' ' + to_string(45.0),
        to_string(1) + ' ' + to_string(44.5),
        to_string(3) + ' ' + to_string(90.0),
        to_string(1) + ' ' + to_string(44.5),
        to_string(3) + ' ' + to_string(90.0),
        to_string(1) + ' ' + to_string(44.5),
        to_string(3) + ' ' + to_string(100.0),
        to_string(1) + ' ' + to_string(37.5),
        to_string(3) + ' ' + to_string(80.0),
        to_string(1) + ' ' + to_string(32.0),
        to_string(3) + ' ' + to_string(90.0),
        to_string(1) + ' ' + to_string(32.0),
        to_string(3) + ' ' + to_string(90.0),
        to_string(1) + ' ' + to_string(32.0),
        to_string(3) + ' ' + to_string(105.0),
        to_string(1) + ' ' + to_string(25.0),
        to_string(3) + ' ' + to_string(75.0),
